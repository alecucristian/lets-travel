...
exports.homePageFilters = async (req, res, next) => {
    try {
        ...
        res.render('index', { title: 'Let\'s travel', filteredHotels, filteredCountries });
...
exports.editRemoveGet = (req, res) => {
    res.render('edit_remove', { title: 'Search for hotels to edit or remove'});
}
...
exports.updateHotelPost = async (req, res, next) => {
    try{
        ...
        req.flash('succes', `${hotel.hotel_name} updated successfully`);
